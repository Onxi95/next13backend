...
export type ProductsGetListQuery = { products?: { data: Array<{ id?: string | null, attributes?: { name: string, description: string, categories?: { data: Array<{ attributes?: { name: string } | null }> } | null, images: { data: Array<{ attributes?: { name: string, caption?: string | null, width?: number | null, height?: number | null, formats?: unknown | null } | null }> } } | null }> } | null };
